             ...
             <div className={"bg-gradient-to-tl from-white to-neutral-500 rounded-2xl p-0.5"}>
                ...
                <div className="hover:cursor-pointer sm:w-6/12 w-[95vw] flex justify-center items-center sm:gap-6 gap-2">
                    <div className="expander relative sm:w-[60px] w-[45px] min-h-[350px] h-auto   max-h-[350px] rounded-3xl overflow-hidden flex justify-center items-center p-2">
                        <h1 className={`bg-red-900 ${pressStart2P.variable} font-serif text-xs align-bottom whitespace-nowrap rotate-90 heading absolute  sm:-left-16 -left-16 top-[50%]`}>Software Engineer</h1>
