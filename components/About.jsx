            ...
            <div className={"flex justify-around items-center gap-4 p-8 md:flex-row flex-col"}>
             <div className={"bg-gradient-to-tl from-white to-neutral-500 rounded-2xl p-0.5"}>
                ...
                <div className="hover:cursor-pointer sm:w-6/12 w-[95vw] flex justify-center items-center sm:gap-6 gap-2">
                    <div className="expander relative sm:w-[60px] w-[45px] h-auto min-h-[450px]  max-h-[350px] rounded-3xl overflow-hidden flex justify-center items-center p-2">
                    ...
                    <div className="expander relative sm:w-[60px] w-[45px] min-h-[350px] h-auto  max-h-[450px] rounded-3xl overflow-hidden flex justify-center items-center p-2">
                        <h1 className={`${pressStart2P.variable} bg-red-800 align-bottom whitespace-nowrap rotate-90 heading absolute  sm:-left-10 -left-10 top-[50%]`}>Software Engineer</h1>
                        <p className={`${roboto.variable} content opacity-0 `}>0 01 1 1010101010101 1010101010 010 01010101 101010101 1010 0 0101010 010 0101 1010101 1 1010 0101 10101010101 1010101010 01 101010 01 1010101 10101010101 1010101 101 1010101010 010101 1010101010101 101010101 10101010 0101010101 101010 01 1 10101010 010101010 0 0101010101 10</p>
                    </div>
                </div>
