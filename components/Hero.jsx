                ...
                <div className={"flex sm:flex-row flex-col justify-center items-center sm:gap-8 gap-1 p-1"}>
                    <div>
                        <div className={`${pressStart2P.variable} font-serif mx-auto z-1 relative sm:text-3xl text-xl text-[#F0F0F0] max-w-[900px] min-w-[450px]  text-center sm:p-4 p-12 rounded-lg min-h-[350px] m-4`}>
                            ...
                            <h3 id={"hello2"} className={"sm:text-lg text-sm opacity-0 text-transparent bg-clip-text bg-gradient-to-br from-neutral-600  to-white"}>Security Researcher</h3>
                            <h3 id={"hello3"} className={"sm:text-lg text-sm opacity-0 sm:px-1, px-3 text-transparent bg-clip-text bg-gradient-to-tr from-white to-neutral-600"}>Software Engineer</h3>
                        </div>
                    </div>
